const PUBLIC_URL = process.env.PUBLIC_PATH;
...
export default {
    ...
    load: preloader =>  {
        ...
        preloader.load.atlasJSONHash('starfield.planets.type-2', `${PATH_ASSETS}/starfield/background_planets02.png`, `${PATH_ASSETS}/starfield/background_planets02.json`);
        preloader.load.atlasJSONHash('starfield.meteorites', `${PATH_ASSETS}/starfield/background_meteorites.png`, `${PATH_ASSETS}/starfield/background_meteorites.json`);
    }
}
